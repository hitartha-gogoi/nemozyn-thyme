...
function ProductPage() {
  return (
    <div className='relative flex flex-col items-center justify-center w-full bg-white overflow-x-hidden pt-20'>
      ...
      <div className="flex flex-row items-center justify-center flex-wrap text-center w-full pt-2 pb-4">
        ...
        <div className="flex flex-col items-center justify-center text-center w-full sm:w-1/2 px-2 sm:px-20 mt-12  sm:mt-32">
            ...
            <div className="flex justify-between items-center w-full py-2 border-y-2 mt-4 border-black text-black ">
                <span style={{ fontSize: "8px "}} className="font-medium text-xs uppercase">Product details</span>
            ...
            <div className="flex justify-between items-center w-full py-2 border-b-2 border-black text-black ">
                <span style={{ fontSize: "8px "}} className="font-medium text-xs uppercase">fabric care</span>
                <input type="radio" value={"fabric"} />
            </div>

            <div className="flex justify-between items-center w-full py-2 border-b-2 border-black text-black ">
                <span style={{ fontSize: "8px "}} className="font-medium  uppercase">cost and transparency</span>
                <input type="radio" value={"cost"} />
            </div>

            <div className="flex justify-between items-center w-full py-2 border-b-2 border-black text-black ">
                <span style={{ fontSize: "8px "}} className="font-medium uppercase">Shipping & Returns</span>
      ...
      <h1 style={{ fontSize: "15px "}} className="text-center uppercase font-medium text-black mt-40">recommended pairing</h1>
      ...
      <div className="flex flex-col items-center justify-center text-center w-full py-4 mt-40 text-black">
        <h1 style={{ fontSize: "15px "}} className="text-center uppercase font-medium ">recommended products to pair with</h1>
        <Cards />
      </div>
      ...
      <div className="flex flex-row justify-evenly items-center flex-wrap border-y-2 border-gray-950 w-full py-4 mt-10 text-black">
        ...
        <div className="flex flex-col items-center justify-center text-center w-80 py-10">
           <FaGavel size={30} />
            ...
            <p style={{ fontSize: "12px" }} className="text-gray-950 text-sm mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt voluptatibus quam unde.</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center text-center w-80 py-10">
           <FaGavel size={30} />
            ...
            <p style={{ fontSize: "12px" }} className="text-gray-950 text-sm mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt voluptatibus quam unde. Est dicta voluptatum aut facilis sequi culpa perferendis quidem? </p>
        </div>
