...
function OrderConfirmationPage() {
  ...
  return (
    <div className='relative flex flex-col items-center justify-center w-full bg-white overflow-x-hidden pt-20'>
      ...
      <h1 style={{ fontSize: "15px "}} className="text-center uppercase font-semibold text-black mt-32">order confirmation</h1>
      <h1 style={{ fontSize: "13px "}} className="text-center font-semibold text-black mt-6 uppercase">thank you</h1>
      <p style={{ fontSize: "13px "}} className="text-center font-semibold text-black uppercase">your order has been placed</p>
      <p style={{ fontSize: "13px "}} className="text-center font-semibold text-black uppercase mt-4">order id: #3366</p>
      ...
      <h1 style={{ fontSize: "13px "}} className="text-center uppercase font-medium text-black mt-10">first name, last name</h1>
        ...
        <p style={{ fontSize: "13px "}} className="text-center font-medium text-black uppercase mb-60">phone number</p>
