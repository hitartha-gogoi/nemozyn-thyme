...
function CreateAccountPage() {
  ...
  return (
    <div className='relative flex flex-col items-center justify-center w-full bg-white overflow-x-hidden pt-20'>
      ...
      <h1 style={{ fontSize: "15px "}} className="text-center uppercase font-semibold text-black mt-32 overused-grotesk-semibold">create account</h1>
      ...
      <form onSubmit={createAccount} className="flex flex-col items-center justify-center flex-wrap text-center w-full pt-2 pb-4 mt-12">
        ...
        <h1 style={{ fontSize: "14px "}} className="text-left overused-grotesk-semibold font-semibold text-black mt-10 w-80 sm:w-[26.5rem]">Birthday</h1>
        ...
        <p className="font-semibold w-80 text-left sm:w-[26rem] flex space-x-2 mt-2"><input type="checkbox" className="" />   <span className="text-sm text-black overused-grotesk-semibold">Non-Binary</span></p>
        <p className="font-semibold w-80 text-left sm:w-[26rem] flex space-x-2 mt-2"><input type="checkbox" className="" />   <span className="text-sm text-black overused-grotesk-semibold">Woman</span></p>
        <p className="font-semibold w-80 text-left sm:w-[26rem] flex space-x-2 mt-2"><input type="checkbox" className="" />   <span className="text-sm text-black overused-grotesk-semibold">Man</span></p>
        <p className="font-semibold w-80 text-left sm:w-[26rem] flex space-x-2 mt-2"><input type="checkbox" className="" />   <span className="text-sm text-black overused-grotesk-semibold">Prefer not to say</span></p>
        <p className="font-semibold w-80 text-left sm:w-[26rem] flex items-center space-x-2 mt-2"><input type="checkbox" className="" />   <span className="text-sm text-black overused-grotesk-semibold">Self describe</span><input className="w-48 sm:w-72 border border-black h-8" /></p>

        <p style={{ fontSize: "12px" }} className=" text-sm font-medium text-black text-left sm:text-center mt-8 px-4 w-80 sm:w-[30rem] overused-grotesk-semibold">We ask for your gender only to help personlize your experience, Your identity is yours to define, and we're here to support that. You can update or remove this information anytime in your profile settings</p>
