...
function AboutPage() {
  ...
  return (
    <div className='relative flex flex-col items-center justify-center w-full bg-white overflow-x-hidden pt-20'>
      ...
      <h1 style={{ fontSize: "15px "}} className="text-center uppercase font-semibold text-black mt-32">About Thyme</h1>

      <p style={{ fontSize: "12px" }} className="banner-text text-sm font-medium text-black text-left px-4 w-4/5 sm:w-96 mt-8">At Thyme we are always looking for like-minded content creators who share our passion for making sustainable fashion more accesible to everyone.     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Distinctio perferendis, fugit molestiae consequuntur qui, error harum repellat natus suscipit aliquid mollitia temporibus deleniti optio praesentium reprehenderit eveniet culpa cupiditate similique.</p>
      <p style={{ fontSize: "12px" }} className="banner-text text-sm font-medium text-black text-left px-4 w-4/5 sm:w-96 mt-6">At Thyme we are always looking for like-minded content creators who share our passion for making sustainable fashion more accesible to everyone.     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Distinctio perferendis, fugit molestiae consequuntur qui</p>
      ...
      <div className=" flex flex-row justify-center items-center w-3/5 flex-wrap mt-20">
      ...
      <div className="flex flex-row items-start justify-start flex-wrap w-4/5 sm:w-3/5 py-4 mt-10 text-black">
          ...
          <div className="h-96 w-96 sm:w-1/2 flex flex-col justify-center items-start p-4 text-black my-4">
            <div className="text-left text-sm font-normal">
      ...
      <Image alt="image" height={600} objectFit="contain" width={600} className="h-96 w-3/5 mt-24" src="/journal-image.jpg"  />
      <h1 style={{ fontSize: "15px "}} className="text-center uppercase font-semibold text-black mt-32">accountibility</h1>
      <p style={{ fontSize: "12px" }} className="banner-text text-sm font-medium text-black text-left px-4 w-4/5 sm:w-96 mt-8">At Thyme we are always looking for like-minded content creators who share our passion for making sustainable fashion more accesible to everyone.     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Distinctio perferendis, fugit molestiae consequuntur qui, error harum repellat natus suscipit aliquid mollitia temporibus deleniti optio praesentium reprehenderit eveniet culpa cupiditate similique.</p>
      <p style={{ fontSize: "12px" }} className="banner-text text-sm font-medium text-black text-left px-4 w-4/5 sm:w-96 mt-6">At Thyme we are always looking for like-minded content creators who share our passion for making sustainable fashion more accesible to everyone.     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Distinctio perferendis, fugit molestiae consequuntur qui</p>

      <h1 style={{ fontSize: "15px "}} className="text-center uppercase font-semibold text-black mt-32">the team behind thyme</h1>
      <p style={{ fontSize: "12px" }} className="banner-text text-sm font-medium text-black text-center px-4 w-4/5 sm:w-96 mt-8">Meet the team that makes Thyme happen, everyday.</p>

      <div className="flex flex-row justify-center sm:justify-between items-center w-full">
