...
function CheckoutPage() {
  ...
  return (
    <div className='relative flex flex-col items-center justify-center w-full bg-white overflow-x-hidden pt-20'>
      ...
      <h1 style={{ fontSize: "15px "}} className="text-center uppercase font-semibold text-black mt-20">contact</h1>
      <form onSubmit={onCheckout} className="flex flex-col items-center justify-center flex-wrap text-center w-full pt-2 pb-4">
        ...
        <h1 style={{ fontSize: "15px "}} className="text-center uppercase font-semibold text-black mt-12">delivery</h1>
        ...
        <h1 style={{ fontSize: "15px "}} className="text-center uppercase font-semibold text-black mt-24">order summary</h1>

        <h1 style={{ fontSize: "15px "}} className="text-center font-semibold text-black mt-12">Total: $3299 [Inclusive of all taxes]</h1>
        ...
        <div className="flex flex-col items-center justify-center w-full mt-12">
            ...
            <button type="submit" className="px-10 py-4 text-center flex justify-center items-center w-60 h-10 border-2 border-black self-center text-black text-base font-medium hover:scale-105 duration-200 ease-in-out transition-all hover:shadow-md shadow-sm hover:text-white hover:bg-black mt-6">Pay Now </button>
            <p style={{ fontSize: "15px "}} className="text-center font-semibold text-black mt-6">Enjoy complimentary shipping and 7 day free returns</p>
        </div>
